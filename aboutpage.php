  ...
  <body>
    ...
    <header class="page-header header container-fluid">
        ...
        <div class="container features">
            <h1>About Us</h1>
                <p>Good things happen when people can send packages from point A to point B.
                We care about that, so we have made this process faster, cheaper and more efficient than ever! 
                Just for you.
                </p>
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-10">
                    ...
                    <img src="https://i2.wp.com/lifenet.com/wp-content/uploads/2018/07/ShipBack.jpg?w=1254&ssl=1" class="img-fluid">
                    <p>•You post your need for sending something locally or regionally</p>
                  </div>
          
                  <div class="col-lg-4 col-md-6 col-sm-10">
                      <h3 class="feature-title">TRANSPORT</h3>
                      <img src="https://i0.wp.com/metro.co.uk/wp-content/uploads/2019/05/SEI_65474835.jpg?quality=90&strip=all&zoom=1&resize=644%2C429&ssl=1" class="img-fluid">
                      <p>•An affiliated driver comes to pick up your package and transports it to the destination.</p>
                    </div>
          
                  <div class="col-lg-4 col-md-6 col-sm-10">
                    <h3 class="feature-title">RECEIVE</h3>
                    <img src="https://unival-logistics.com/img/Parcel-Delivery-Los-Angeles-California.jpg" class="img-fluid">
                    <p>•You receive your package and the confirmation of the successful delivery is immediate.</p>
                  </div>
                  <h4>As your transation's safety is our primary, you have noting to worry about, </h4>
                    <h4> but planning the destination of your next delivery.</h4> 
