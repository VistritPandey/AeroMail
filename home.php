  ...
  <div>
    <header class="page-header header container-fluid">
      ...
      <div class="description">
        <h1>Confratualations! Your are successfully loged in! Now visit your profile page!</h1>
        <p>Welcome back, <?=$_SESSION['name']?>!</p>
        <p>Place an order or pickup a package.</p>

        <a href="profile.php"><button class="btn btn-outline-secondary btn-lg" href="profile.php">Profile is here!</button>

        <a href="logout.php"><button class="btn btn-outline-secondary btn-lg" href="logout.php">Press to logout!</button>
