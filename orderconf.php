...
<html lang="en">
  ...
  <body>
      ...
      <div class="description">
        <h1>Confratualations! Your order has been placed successfully!</h1>
        <p>Please check your email for tracking number.</p>

        <button class="btn btn-link btn-outline-secondary btn-lg" href="senderform.php">Ship another item</button>

        <button class="btn btn-link btn-outline-secondary btn-lg" href="deliveryform.php">Check order status</button>
