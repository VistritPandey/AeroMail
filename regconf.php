...
<html lang="en">
  ...
  <body>
      ...
      <div class="description">
        <h1>Confratualations! Your Registration Submitted! You ready to rock!!!</h1>
        <p>Please place your first order or pickup first package.</p>

        <a href="senderslogin.php"><button class="btn btn-outline-secondary btn-lg" href="senderslogin.php">Sender Login</button>

        <a href="driverslogin.php"><button class="btn btn-outline-secondary btn-lg" href="driverslogin.php">Driver Login</button>
