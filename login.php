  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md">
      ...
      <div class="description">
        ...
        <a class="d-block text-center mt-2 small text-uppercase" href="senderslogin.php">Login as a sender</a>
        <a class="d-block text-center mt-2 small text-uppercase" href="driverslogin.php">Login as a driver</a>
