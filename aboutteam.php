  ...
  <body>
    ...
    <header class="page-header header container-fluid">
        ...
        <div class="container features">
            <h1>Meet Our Team</h1>
                <p>Students of Drexel College of Computing and Informatics 
                  developing an innovative platform for On-The-Way delivery services. 
                  We are committed to delivering the best value for our customers.</p>

            <div class="row">             
                <div class="col-lg-2 col-md-4 col-sm-8 col-xs-12">
                    <h3 class="feature-title">Liam</h3>
                    <img src="img/liam.png" class="img-fluid">
                    <p>Computer Science</p>
                  </div>
          
                  <div class="col-lg-2 col-md-4 col-sm-8 col-xs-12">
                      <h3 class="feature-title">Vistrit</h3>
                      <img src="img/vistrit.png" class="img-fluid">
                      <p>Computer Science</p>
                    </div>
          
                  <div class="col-lg-2 col-md-4 col-sm-8 col-xs-12">
                    <h3 class="feature-title">Minodora</h3>
                    <img src="img/minodora.jpg" class="img-fluid">
                    <p>Computer Science</p>
                  </div>
            
                    <div class="col-lg-2 col-md-4 col-sm-8 col-xs-12">
                      <h3 class="feature-title">Artem</h3>
                      <img src="img/artem.jpg" class="img-fluid">
